      ...
      <Card className="w-96">
        <form onSubmit={handleSubmit}>
          <CardHeader
            variant="gradient"
            color="gray"
            className="mb-4 grid h-28 place-items-center bg-gradient-to-r from-blue-500 to-teal-400"
          >
          ...
          <CardFooter className="pt-0">
            <Button type="submit" variant="gradient" fullWidth className="bg-gradient-to-r from-blue-500 to-teal-400">
              Sign Up
            </Button>
